...
SCAN_PATHS = [
    r"C:\Users\zZ\.openclaw\workspace\memory",
    r"D:\openclaw\color_science_documents"
]
CORE_MEM_FILE = r"C:\Users\zZ\.openclaw\workspace\MEMORY.md"
...
def sanitize_content(text: str) -> str:
    ...
    text = re.sub(r'[a-zA-Z]:\\Users\\[^\s]+', '[本地路径]', text)
    return text
...
def build_memory_graph() -> Dict[str, Any]:
    ...
    for path in all_files:
        ...
        file_map[name] = path
        group = 1 if "workspace" in path else 2
